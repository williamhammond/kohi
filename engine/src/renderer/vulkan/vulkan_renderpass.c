...
void vulkan_renderpass_create(
    ...
    VkAttachmentDescription attachment_descriptions[MAX_ATTACHMENT_COUNT];
    ...
    // Attachment used for multisampling color
    ...
    render_pass_create_info.attachmentCount = MAX_ATTACHMENT_COUNT;
