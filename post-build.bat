...
IF %ERRORLEVEL% NEQ 0 (echo Error: failed to compile vertex shader code:%ERRORLEVEL% && exit)
...
IF %ERRORLEVEL% NEQ 0 (echo Error: failed to compile fragment shader code:%ERRORLEVEL% && exit)
